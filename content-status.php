<div class='casual-post'>
  ...
  <div class='container single-thumbnail' style='background-image:url("<?php the_post_thumbnail_url(); ?>");width:90%;'>
  </div>
    ...
    <div class='row' >
      <div class='col-lg-3'>
        ...
        if( $ads->have_posts() ){
         ...
         ?>
         <div class='ads' style='background-image:url("<?php  the_post_thumbnail_url();  ?>")'>
         </div>
